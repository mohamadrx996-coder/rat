    ...
    <div style={S.center}>
      ...
      <form onSubmit={submit} style={S.card}>
        ...
        <div style={{ fontSize: 11, color: '#3a6a4a', marginBottom: 16 }}>
          أدخل رقم منفذ المستمع (LISTENER_PORT) الذي شغّلته على جهازك.
        </div>
        <label style={S.lbl}>
    ...
    <div>
      <div style={S.panel}>
        ...
        <div style={{ fontSize: 11, color: '#3a6a4a', marginBottom: 14 }}>
          البايلود سيستخدم منفذ المستمع :{auth.port} على نفس نطاق الموقع — الوكيل يعود نحو مستمعك وليس نحو موقع خارجي.
        </div>
